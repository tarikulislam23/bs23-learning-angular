...
import { MenuService } from 'src/app/core/services/app-services/app.menu.service';
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public app: OneColumnLayoutComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
